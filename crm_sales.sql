...
-- PSQL Tools for the data import
crm_sales=# \COPY accounts FROM 'C:\Users\bolajif\Documents\Algora\Hackathon\CRM Sales+Oppor
tunities\accounts.csv' DELIMITER ',' CSV HEADER;
COPY 85
crm_sales=# \COPY products FROM 'C:\Users\bolajif\Documents\Algora\Hackathon\CRM Sales+Oppor
tunities\products.csv' DELIMITER ',' CSV HEADER;
COPY 7
crm_sales=# \COPY sales_teams FROM 'C:\Users\bolajif\Documents\Algora\Hackathon\CRM Sales+Op
portunities\sales_teams.csv' DELIMITER ',' CSV HEADER;
COPY 35
crm_sales=# \COPY sales_pipeline FROM 'C:\Users\bolajif\Documents\Algora\Hackathon\CRM Sales
+Opportunities\sales_pipeline.csv' DELIMITER ',' CSV HEADER;
COPY 8800
